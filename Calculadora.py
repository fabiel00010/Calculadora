...
titulo = Label(frame,text="CALCULADORA DE PipS")
...
lbl_numeroa = Label(raiz, text="Dato 1").place(relx=0.2,rely=0.2)
...
lbl_numerob = Label(raiz, text="Dato 2").place(relx=0.2,rely=0.3)
...
rbt_borrar = Button(raiz, text="     C     ",command=borra).place(relx=0.6,rely=0.5)
